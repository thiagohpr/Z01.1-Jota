...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Desktop/Z01.1-Jota/vunit_out/test_output/lib.tb_halfadder.all_2a9f30afe01faed90d95ca9cf2cee2354e984c4c/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {/usr/bin/python3 -u Projetos/C-UnidadeLogicaAritmetica/testeULA.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', 'Projetos/C-UnidadeLogicaAritmetica/testeULA.py', '--compile'], cwd='/home/borg/Desktop/Z01.1-Jota', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
